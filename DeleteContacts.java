...
class DeleteContacts extends JFrame{
	...
	DeleteContacts(){
		...
		Title=new JLabel("Delete Contact", SwingConstants.CENTER);
		...
		Delete.setBounds(450,400,100,40);
		Delete.setBackground(new Color(169, 207, 203));
		Delete.setForeground(new Color(5, 43, 40));
		Delete.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				DBConnection.getInstance().getContactList().remove(index);
				//ContactsController.contactList.trimToSize();
				SearchField.setText("");
				Id.setText("");
				Name.setText("");
				PhoNumber.setText("");
